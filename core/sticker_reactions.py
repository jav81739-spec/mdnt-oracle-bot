...
async def sticker_to_sticker(update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
def install(application) -> None:
    application.add_handler(MessageHandler(filters.Sticker.ALL, sticker_to_sticker), group=15)
