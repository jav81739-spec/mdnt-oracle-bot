...
def register_phase_surfaces(app) -> None:
    ...
    from .world_handler import start_game, game_callback, handle_game_message, handle_poll_answer, handle_poll, end_game
    ...
    app.add_handler(CommandHandler("endgame", end_game), group=-30)
    ...
    app.add_handler(CallbackQueryHandler(handle_callback, pattern=r"^(?:reveal_|secret:|game:).+"), group=-29)
