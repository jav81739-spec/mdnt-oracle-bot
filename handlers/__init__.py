...
def _register_legacy_surface(app) -> None:
    ...
    modules = {
        ...
        "economy": {"daily": ("daily",), "balance": ("balance",), "gamble": ("gamble",), "richest": ("economy_leaderboard",), "coinboard": ("economy_leaderboard",)},
        ...
        "deathgames": {"survive": ("survive",), "revive": ("revive",), "deathstatus": ("deathstatus",), "roulette": ("roulette",), "joingame": ("joingame",), "startround": ("startround",), "kill": ("kill",), "vote": ("vote",), "endgame": ("endgame",), "deathgame": ("deathgame",)},
    }
