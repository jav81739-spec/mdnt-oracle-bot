...
_PROTECTED = {"broadcast","announce","midnightmap","ownerstatus","ownerstats","setcommands","reload","shutdown","restart","admin","moderation","mute","unmute","ban","kick","warn","clearwarns","pin","unpin","purge","setrules","lock","unlock","groupinfo","setwelcome","setgoodbye","rob","withdraw","deposit","buy","gift","kill","vote","endgame","startround","deathgame"}
...
def register_legacy_surface(app):
    ...
    reserved={"start","help","oracle","truth","memory","mymemory","forget","tod","wyr","nhie","scramble","unscramble","predict","predictions","house","quiet","wake","bond"}
