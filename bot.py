...
# ══════════════════════════════════════════════════════════════════════════
BOT_COMMANDS=[
    # ── DAILY ENGAGEMENT (most important — drives activity) ──
    ...
    BotCommand("coinboard",     "🏆 Top coin holders"),
    BotCommand("richest",       "💎 Economy leaderboard"),
    BotCommand("work",          "⚒️ Earn coins by working"),
    BotCommand("cgift",         "💝 Gift coins (reply to msg)"),
    BotCommand("rob",           "🦹 Rob someone (reply)"),
    ...
    BotCommand("slots",         "🎰 Spin the slot machine"),
    BotCommand("roulette",      "💀 Russian roulette"),

    # ── VAULT ──
    BotCommand("wallet",        "🏦 Your protected coin vault"),
    ...
    BotCommand("ritual",        "🕯️ Today's ritual from the Oracle"),
    BotCommand("duality",       "☯️ Your light and dark side"),
    ...
    BotCommand("crush",         "💘 Secretly pick a crush (reply)"),
    ...
    BotCommand("tictactoe",     "⭕ Challenge to tic-tac-toe"),
    BotCommand("wordchain",     "🔤 Start a word chain"),
    BotCommand("trivia",        "📚 Trivia by category"),
    BotCommand("wordle",        "🟩 Today's wordle"),
    BotCommand("impostor",      "🕵️ Start an impostor round"),
    ...
    BotCommand("shop",          "🛍️ Browse the item shop"),
    BotCommand("buy",           "💳 Buy from shop"),
    ...
    BotCommand("warn",          "⚠️ Warn a user (admin)"),
    BotCommand("purge",         "🗑️ Delete N messages (admin)"),
